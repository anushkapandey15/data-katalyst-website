    ...
    const timelineSections = [
        {
            id: 0,
            title: "Persona",
            description: "Define user groups with tailored attributes.",
            timeRange: { start: 0, end: 7 },
        },
        {
            id: 1,
            title: "Permission Schema",
            description: "Set structured rules for data access control",
            timeRange: { start: 8, end: 21 },
        },
        {
            id: 2,
            title: "Data Access",
            description:
                "Enable secure and compliant data availability.",
            timeRange: { start: 22, end: 32 },
        },
        {
            id: 3,
            title: "Profile",
            description: "Capture individual user details and preferences.",
            timeRange: { start: 33, end: 40 },
        },
        {
            id: 4,
            title: "Role",
            description: "Assign responsibilities with clear access boundaries",
            timeRange: { start: 41, end: 57 },
        }
    ];
                    ...
                    <div className="lg:col-span-3 relative">
                        <div className="bg-gray-100 rounded-2xl overflow-hidden shadow-lg">
                            ...
                            >
                                ...
                                <source
                                    src="/src/components/images/DataGovernance.mov"
                                    type="video/mp4"
                                />
...
<div
  ...
  style={
    (() => {
      if (!duration) return { top: "0%", height: "0%" };
      ...
      if (currentSectionIndex === -1) return { top: "0%", height: "0%" };

      const sectionCount = timelineSections.length;
      const sectionHeight = 100 / sectionCount;
      const sectionTop = currentSectionIndex * sectionHeight;
      ...
      const sectionProgress =
        ...
        return {
            top: `calc(${sectionTop}% + 12px)`,   // push line start below the circle radius (adjust px if needed)
            height: `calc(${sectionProgress * sectionHeight}% - 12px)`, // stop before hitting next circle
          };
    })()  // <- immediately call the function so it returns an object
  }
/>
